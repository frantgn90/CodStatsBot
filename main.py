...
if __name__ == "__main__":
    ...
    parser.add_argument('--cod_user', required=True, type=str, help='The COD platform user')
    parser.add_argument('--cod_pass', required=True, type=str, help='The COD platform user')
    parser.add_argument('--updates_timeout_s', type=int, help='Timeout for taking updates from telegram',
